...
- <font size=5>现已支持.m3u8格式视频直播流</font><br><br>

- <font size=5>轻量级视频播放控件，只需要设置一个View</font><br><br>

- <font size=5>可以任意位置使用的playView，用于播放</font><br><br>

- <font size=5>可以全屏，进度拖动，来回切换</font><br><br>
###支持视频直播解析 .m3u8文件
